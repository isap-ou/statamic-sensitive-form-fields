...
3. Apply session-start doc sync rule from `AGENTS.md` (Workflow Rules).
...
- Update memory when requirements, architecture, or behavior changes, or when pre-existing staleness is discovered.
